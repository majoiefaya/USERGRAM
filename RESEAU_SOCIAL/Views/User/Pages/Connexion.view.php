			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="login-reg-bg">
					<div class="log-reg-area sign">
						...
						<form method="post" action="../../../../RESEAU_SOCIAL/Controllers/User/Connexion.controller.php">
					...
					<div class="log-reg-area reg">
						...
						<form method="post"  action="../../../../RESEAU_SOCIAL/Controllers/User/addUser.controller.php">
							<div class="form-group">	
