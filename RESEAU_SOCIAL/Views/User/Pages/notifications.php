								...
								<aside class="sidebar static">
									...
									<div class="widget stick-widget">
										...
										<ul class="naves">
											...
											<li>
												<i class="ti-image"></i>
												<a title="" href="timeline-photos.php">images</a>
											</li>
											<li>
												<i class="ti-video-camera"></i>
												<a title="" href="timeline-videos.php">videos</a>
											</li>
											<li>
									...
									<div class="editing-interest">
										...
										<div class="notification-box">
											...
											<?php
												...
												?>      
												<li> 
													<figure><img src="../../../../RESEAU_SOCIAL/views/User/User_img_Profil/<?php echo $notification["user_picture"];?>"/></figure></figure>
													<div class="notifi-meta">
														<p><?php echo $notification["sujet"] ?></p>
														<span><?php echo $notification["noti_content"] ?></span>
													</div>
